"""djangoCursoDjango URL Configuration
...
urlpatterns = [
    ...
    path('formulario/', HomeView.formularios, name='formularioPrueba'),
    ...
    path('eliminarAlumnos/<int:id_alumno>', FormularioAlumnoView.delete, name='eliminararAlumnos'),
]
